...
var errorMap = { // https://developer.apple.com/documentation/appstorereceipts/status
...
module.exports.validatePurchase = function (secret, receipt, cb) {
    ...
    var done = function (error) {
        ...
        handleResponse(validatedData, cb);
    };
...
function handleResponse(data, cb) {
    ...
    // failed to validate
    cb(new Error('failed to validate receipt'), data);
}
